    ...
    body: SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Terms and Conditions',style: _heading_text,),
        
            Text('Last updated: April 24, 2024',style: _text,),
        
            Text('Please read these terms and conditions carefully before using Our Service.',style: TextStyle(fontSize: 17),),
        
            Text('Interpretation and Definitions',style: TextStyle(fontSize: 23,fontWeight: FontWeight.bold),),
        
             Text('Interpretation',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
        ...
        You means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.''' ,),
            ...
            Text('Acknowledgment',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
        ...
        Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company. Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy Policy carefully before using Our Service.''' ,),
            ...
            Text('Links to Other Websites',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
        ...
        We strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or services that You visit.''' ,),
            ...
            Text('Termination',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
        ...
        Upon termination, Your right to use the Service will cease immediately.''' ,),
            ...
            Text('Limitation of Liability',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
        ...
        Some states do not allow the exclusion of implied warranties or limitation of liability for incidental or consequential damages, which means that some of the above limitations may not apply. In these states, each party's liability will be limited to the greatest extent permitted by law.''' ,),
            ...
            Text('"AS IS" and "AS AVAILABLE" Disclaimer',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
        ...
        Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable statutory rights of a consumer, so some or all of the above exclusions and limitations may not apply to You. But in such a case the exclusions and limitations set forth in this section shall be applied to the greatest extent enforceable under applicable law.''' ,),
             ...
             Text('Governing Law',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
            ...
            Text('Disputes Resolution',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
            ...
            Text('For European Union (EU) Users',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
            ...
            Text('United States Legal Compliance',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
            ...
            Text('''You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.''' ,),
             ...
             Text('Severability and Waiver',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
        
            Text('Severability',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15),),
            ...
            Text('Waiver',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15),),
            ...
            Text('Translation Interpretation',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
            ...
            Text('Changes to These Terms and Conditions',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold)),
