...
class HistoryPage extends StatefulWidget {
  ...
  @override
  State<HistoryPage> createState() => _Rented_CarsState();
}

class _Rented_CarsState extends State<HistoryPage> {
                        ...
                        onTap: () {
                          Navigator.of(context)
                              .push(MaterialPageRoute(
                                  builder: (context) =>historyDetailPage(carRental: listToShow[index])))
