      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text('Welcome to EasyRent,',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
          ),

          Padding(
            padding: const EdgeInsets.all(8.0),
            child: Text('''Your go-to destination for hassle-free car rentals! Whether you're planning a weekend getaway or need a reliable ride for your daily commute, we've got you covered. At EasyRent, we strive to make renting a car as simple as possible, offering a seamless experience from start to finish.
