...
class RevenuePage extends StatefulWidget {
  ...
  @override
  State<RevenuePage> createState() => _Rented_CarsState();
}

class _Rented_CarsState extends State<RevenuePage> {
                        ...
                        onTap: () {
                          Navigator.of(context)
                              .push(MaterialPageRoute(
                                  builder: (context) => RevenuePageDetail(carRental: listToShow[index])))
